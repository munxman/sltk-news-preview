/* SL Tervisekeskus — main.js  v1.1  2026-08-18
   Minimal JS: sticky offset, mobile nav, FAQ accordion, registration form intercept.
   No frameworks, no dependencies. */

(function () {
  'use strict';
  /* -- Sticky offset: set --bar-h dynamically so header never overlaps ribbon -- */
